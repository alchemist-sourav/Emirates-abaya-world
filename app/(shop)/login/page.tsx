...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Truck, RotateCcw } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid md:grid-cols-2 bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-8 lg:p-12">
            <h2 className="font-heading text-xl font-bold text-[#111111] mb-1">Sign in to your account</h2>
